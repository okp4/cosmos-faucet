...
func TestMutationResolver_Send(t *testing.T) {
    ...
    Convey("Given a graphQL 'send' mutation request", func() {
        m := `
                mutation {
                    send(input: {
                        captchaToken: "token"
        ...
        Convey("And a faucet service configured to succeed", t, func() {
            faucet := mockFaucet{
                config: config,
            }
            srv := gql.New(handler.NewDefaultServer(generated.NewExecutableSchema(generated.Config{Resolvers: &Resolver{Faucet: faucet, CaptchaResolver: newMockCaptchaResolver()}})))
        ...
        Convey("And a faucet service configured to fail", t, func() {
            faucet := mockFaucet{
                config:    config,
                withError: true,
            }
